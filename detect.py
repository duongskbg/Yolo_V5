...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'E:\CCD3\Data\Models/U6LR.pt', help='model path(s)')
    parser.add_argument('--source', type=str, default=ROOT / 'data/aa', help='file/dir/URL/glob, 0 for webcam')
